...
namespace RengeGames.HealthBars.Editors {
    ...
    public class RadialSegmentedHealthBarEditor : Editor {
        ...
        private SerializedProperty offsetPerBar;
        ...
        private void OnEnable() {
            ...
            offsetPerBar = FindSerializedPropertyFromAutoProperty(serializedObject, RadialHealthBarProperties.OffsetPerBar);
        ...
        public override void OnInspectorGUI() {
            ...
            if (generalFoldout) {
                using (new EditorGUILayout.VerticalScope(EditorStyles.helpBox)) {
                    ...
                    EditorGUILayout.PropertyField(offsetPerBar, new GUIContent() { text = "Offset Per Bar", tooltip = "The x and y offset" });
                }
            }
